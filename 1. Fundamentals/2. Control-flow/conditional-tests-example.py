...
# This Python program uses conditional statements 
#   to assign point values based on an alien's color in a game,
#   and determines a person's stage of life based on their age.
# ----------------------------------------------------------
